    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Thêm mới Playlist</h4>
                        @if(count($errors)>0)
                        ...
                        @endif
                            ...
                            {!! Form::close() !!}
                            <form class="form-valide" action="playlists/add" method="post">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-name">Tên Playlist <span class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="playlist_name" placeholder="Nhập Tên Playlist">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-name">Hình ảnh <span class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="playlist_image" placeholder="Nhập hình">
                                    </div>
                                </div>
                                <div class="form-group row">
